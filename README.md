...
### Digital IC Design • ASIC • RTL • Verification • FPGA
...
`AMD/Xilinx Vivado` `Vitis` `Zynq SoC` `AXI` `Embedded C`

### Architecture & Simulation

`RISC-V` `gem5` `SystemC` `TLM`
...
> *Interested in digital hardware from architecture to silicon.*
